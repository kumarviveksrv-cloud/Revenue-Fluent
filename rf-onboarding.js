...
function injectCSS(){
  ...
  style.textContent = [
    /* PANEL */
    '.rf-ob-panel{margin-bottom:28px;border-radius:14px;overflow:hidden;border:1px solid rgba(99,102,241,.2);background:rgba(13,11,30,.95)}',
    '.rf-ob-panel-header{display:flex;align-items:center;justify-content:space-between;padding:14px 20px;cursor:pointer;transition:background .15s;border-bottom:1px solid rgba(99,102,241,.1)}',
    '.rf-ob-panel-header:hover{background:rgba(99,102,241,.06)}',
    '.rf-ob-panel-left{display:flex;align-items:center;gap:10px}',
    '.rf-ob-panel-icon{width:28px;height:28px;border-radius:6px;background:rgba(99,102,241,.15);border:1px solid rgba(99,102,241,.3);display:flex;align-items:center;justify-content:center;flex-shrink:0;color:#a5b4fc;font-size:14px;font-weight:700;font-family:monospace}',
    '.rf-ob-panel-title{font-family:\'DM Mono\',monospace;font-size:.68rem;letter-spacing:.16em;text-transform:uppercase;color:#a5b4fc;font-weight:500}',
    '.rf-ob-panel-sub{font-size:.74rem;color:rgba(244,243,255,0.25);margin-top:2px}',
    '.rf-ob-toggle{font-family:\'DM Mono\',monospace;font-size:.6rem;letter-spacing:.1em;text-transform:uppercase;color:rgba(99,102,241,.5);display:flex;align-items:center;gap:6px;transition:color .15s}',
    '.rf-ob-toggle:hover{color:rgba(99,102,241,.8)}',
    ...
    '.rf-ob-step{background:rgba(13,11,30,.6);border:1px solid rgba(99,102,241,.1);border-radius:10px;padding:14px 16px;position:relative}',
    '.rf-ob-step-num{font-family:\'DM Mono\',monospace;font-size:.56rem;letter-spacing:.12em;text-transform:uppercase;color:rgba(99,102,241,.4);margin-bottom:6px}',
    '.rf-ob-step-title{font-size:.82rem;font-weight:600;color:#f4f3ff;margin-bottom:6px;line-height:1.3}',
    '.rf-ob-step-body{font-size:.76rem;color:rgba(244,243,255,0.25);line-height:1.6}',
    /* TAGLINE + CONNECTS */
    '.rf-ob-tagline{font-style:italic;font-size:.88rem;color:rgba(244,243,255,0.45);line-height:1.6;padding:12px 16px;background:rgba(99,102,241,.05);border-left:2px solid rgba(99,102,241,.3);border-radius:0 8px 8px 0;margin-bottom:14px}',
    '.rf-ob-connects{font-family:\'DM Mono\',monospace;font-size:.6rem;letter-spacing:.08em;color:rgba(99,102,241,.7);padding:8px 14px;background:rgba(99,102,241,.06);border:1px solid rgba(99,102,241,.12);border-radius:6px;line-height:1.5}',
    '.rf-ob-connects b{color:#a5b4fc}',
    /* HINTS */
    '.rf-ob-hint-btn{display:inline-flex;align-items:center;justify-content:center;width:16px;height:16px;border-radius:50%;background:rgba(99,102,241,.12);border:1px solid rgba(99,102,241,.25);color:#a5b4fc;font-size:10px;font-weight:700;font-family:monospace;cursor:pointer;vertical-align:middle;margin-left:5px;flex-shrink:0;transition:all .15s;line-height:1;user-select:none}',
    '.rf-ob-hint-btn:hover{background:rgba(99,102,241,.25);border-color:rgba(99,102,241,.5)}',
    '.rf-ob-tooltip{position:fixed;z-index:9999;max-width:280px;background:#0d0b1e;border:1px solid rgba(99,102,241,.35);border-radius:10px;padding:12px 14px;box-shadow:0 8px 32px rgba(0,0,0,.6);pointer-events:none;opacity:0;transition:opacity .15s}',
    '.rf-ob-tooltip.visible{opacity:1}',
    '.rf-ob-tooltip-title{font-family:\'DM Mono\',monospace;font-size:.6rem;letter-spacing:.12em;text-transform:uppercase;color:#a5b4fc;margin-bottom:6px}',
    '.rf-ob-tooltip-body{font-size:.78rem;color:rgba(244,243,255,0.45);line-height:1.6}',
    /* FLOATING HELP BUTTON */
    '.rf-ob-fab{position:fixed;bottom:24px;right:24px;z-index:500;display:flex;align-items:center;gap:8px;padding:9px 16px;background:rgba(99,102,241,.15);border:1px solid rgba(99,102,241,.3);border-radius:40px;cursor:pointer;transition:all .2s;font-family:\'DM Mono\',monospace;font-size:.62rem;letter-spacing:.1em;text-transform:uppercase;color:#a5b4fc;backdrop-filter:blur(10px)}',
    '.rf-ob-fab:hover{background:rgba(99,102,241,.25);border-color:rgba(99,102,241,.5)}',
...
if(pageId){
  ...
  if(!document.getElementById('rf-ob-css')){
    ...
    style.textContent = [
      ...
      '.rf-ob-panel-body.open{display:block}',
      '.rf-ob-steps{display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:12px;margin-bottom:20px}',
      '.rf-ob-step{background:rgba(13,11,30,.6);border:1px solid rgba(99,102,241,.1);border-radius:10px;padding:14px 16px}',
      '.rf-ob-step-num{font-family:\'DM Mono\',monospace;font-size:.56rem;letter-spacing:.12em;text-transform:uppercase;color:rgba(99,102,241,.4);margin-bottom:6px}',
      '.rf-ob-step-title{font-size:.82rem;font-weight:600;color:#f4f3ff;margin-bottom:6px;line-height:1.3}',
      '.rf-ob-step-body{font-size:.76rem;color:rgba(244,243,255,0.25);line-height:1.6}',
      '.rf-ob-tagline{font-style:italic;font-size:.88rem;color:rgba(244,243,255,0.45);line-height:1.6;padding:12px 16px;background:rgba(99,102,241,.05);border-left:2px solid rgba(99,102,241,.3);border-radius:0 8px 8px 0;margin-bottom:14px}',
